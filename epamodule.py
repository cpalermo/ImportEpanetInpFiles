...
#Fork:https://github.com/Mariosmsk/epanet-python
#Some changes by Marios Kyriakou (mariosmsk@gmail.com)
...
if _plat=='Linux':
  _lib = ctypes.CDLL("libepanet.so.2")
    ...
    if s[0]=="32bit":
        _lib = ctypes.windll.LoadLibrary(getPathPlugin+'epanet2x86.dll') # epanet2.dll
    elif s[0]=="64bit":
        print "64bit"
        _lib = ctypes.windll.LoadLibrary(getPathPlugin+'epanet2x64.dll') # epanet2.dll
else:
