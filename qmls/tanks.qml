...
<qgis version="2.18.17" simplifyAlgorithm="0" minimumScale="0" maximumScale="0" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="VolumeCurv">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="VolumeCurv"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    <default field="ID" expression="'Plu_Tank_'+to_string(update())"/>
    <default field="Elevation" expression="0"/>
    <default field="InitLevel" expression="10"/>
    <default field="MinLevel" expression="0"/>
    <default field="MaxLevel" expression="20"/>
    <default field="Diameter" expression="50"/>
    <default field="MinVolume" expression="0"/>
    <default field="VolumeCurv" expression="''"/>
  </defaults>
